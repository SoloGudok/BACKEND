...
import com.example.backend.domain.user.dto.MonthlyExpenditureSummaryDto;
...
public interface ExpenditureRepositoryCustom {
    ...
    MonthlyExpenditureSummaryDto findExpenditureByMonth(Long userId, int year, int month);
}